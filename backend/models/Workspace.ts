...
import { IWorkspace, IMindmap, IMindmapNode } from "../types/models.js";

const mindmapNodeSchema = new mongoose.Schema<IMindmapNode>(
  {
    title: {
      type: String,
      required: true,
...
const mindmapSchema = new mongoose.Schema<IMindmap>(
  {
    title: {
      type: String,
      required: true,
